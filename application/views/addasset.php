<?php include("inc/header.php");?>
    <?php echo form_open("Admin/createasset",['class' => 'form-horizontal']);?>
    ...
    <?php echo $msg; ?>
        ...
        <br>
        <div class="c1">
        <h3><B>ADD ASSET</h3></B></div>
        <hr><br>

        <label><h5>Asset:</h5></label>
            <?php echo form_input(['name'=> 'assetname','placeholder'=>'Assetname','value'=>set_value('assetname')]);?><br>
            <?php echo form_error('assetname','<div class="d1">','</div>'); ?><br>
